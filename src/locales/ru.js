...
export default {
  ...
  tools: {
    ...
    'salary-calculator': {
      ...
      description: 'Расчет общего пакета, почасовой ставки и повышения'
    },
    'vacation-calculator': {
      name: 'Калькулятор отпуска',
      description: 'Интеллектуальная оптимизация отпускных планов для максимизации времени отдыха'
    }
  },
